...
#    - Trainer con noise-aware (AerSimulator + noise model ibm_fez)
...
# ── Configuración ──────────────────────────────────────────
TOKEN="bOJG1-m-ma6eHouv9SvHuFnxdvRBepdzCQow3BZo7QxE"
BACKEND="ibm_fez"
N_PER_CLASS=80
SHOTS=8192
MAX_ITER=218          # = job de referencia (64.9%)
SEED_BASE=42
OUTPUT_BASE="data/hardware/ibm_fez_noise_aware_runs"
...
echo "  Noise-aware training: AerSimulator + ibm_fez noise model"  | tee -a "$LOG_WRAPPER"
