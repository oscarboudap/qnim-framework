...
methodology, and is extensively discussed in Section~\ref{subsec:disc_qfi_hardware}.
Re-analysis of GW150914 confirms full consistency with General Relativity
across thirteen competing models.
The statistical comparison of QNIM predictions against classical Wilcoxon
signed-rank tests for beyond-GR hypothesis discrimination reaches the
five-sigma level of confidence after Bonferroni multiple-comparison
correction. This represents a formal demonstration of quantum advantage in
...
discussion in Appendix~\ref{app:feature_map_theory}.
...
probability, following the Imaginary Time Schrödinger Equation (ITSE)
formalism:
\begin{equation}
  \label{eq:tunnelling}
...
\label{sec:bayes_factor_formalism}
% ------------------------------------------------------------------
...
\begin{equation}
  \label{eq:bayes_factor_definition}
...
(the ``null'' hypothesis) and $H_1$ represents each of the thirteen beyond-GR
theories in turn (scalar-tensor, LQG, Chern-Simons, etc.).
...
\citeA{Dax_2021}, PE quality is considered satisfactory when
...
Objective~O2 (Section~\ref{subsec:objectives}) uses Kullback–Leibler
...
\begin{table}[htb]
  ...
  \caption{Marginal Jensen--Shannon divergence (nats) between QNIM Fisher
    ...
    The threshold from \citeA{Dax_2021} is $10^{-3}$\,nats.}
...
\begin{itemize}
  ...
  \item \textbf{BNS} (binary neutron star, $N = 2$):
    ...
    \item \textbf{NSBH} (neutron star–black hole, $N = 2$):
      GW200105 and GW200115; GW230529 is an O4 event and is not
      included in the GWTC-3 sample analysed here.
\end{itemize}
...
GW190503\_185404 & BBH  & GR             & 0.819 & $+0.2$ & C \\
...
GW200105\_161121 & NSBH & GR             & 0.838 & $-0.4$ & D \\
